...
//BOOL __stdcall LoadNTDriver(char* lpszDriverName, char* lpszDriverPath);
...
extern "C"
{
	bool __stdcall MsKmKeyPress(USHORT VirtualKey, bool bShift = false, DWORD dwDelay = 100);
	bool __stdcall MsKmMouseLeftClick(DWORD dwDelay = 100);
	bool __stdcall MsKmMouseLeftDbClick(DWORD dwDelay = 100);
	bool __stdcall MsKmMouseRightClick(DWORD dwDelay = 100);
	bool __stdcall MsKmMouseMiddleClick(DWORD dwDelay = 100);
	bool __stdcall MsKmMouseMove(LONG dx, LONG dy);
	bool __stdcall MsKmPressPassword(HWND hGame, LPTSTR lpszText, DWORD dwDelay = 100);
}